...
def main():
    ...
    encrypted_image_path = "D:\Tech Projects\JOKI\ImageToCipherImages\Images\Results\Encrypted\encrypted_image.jpg" # ini path untuk nyimpen hasil enkripsi 
    ...
    show_encrypted_image =  Image.frombytes('L', (256, 256), encrypted_data[:256*256])
    show_encrypted_image.show()
