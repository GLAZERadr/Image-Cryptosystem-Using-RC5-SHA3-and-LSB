...
def cryptography():
    ...
    #images path
    input_image_path = "D:\Tech Projects\JOKI\Cryptosystem RC5 SHA3 LSB\Images\BarangTerlaku TiapNegara.png" # ini path untuk input image yang mau di enkripsi
    encrypted_image_path = "D:\Tech Projects\JOKI\Cryptosystem RC5 SHA3 LSB\Images\Results\Encrypted\encrypted_image.txt" # ini path untuk nyimpen hasil enkripsi 
    decrypted_image_path = "D:\Tech Projects\JOKI\Cryptosystem RC5 SHA3 LSB\Images\Results\Decrypted\decrypted_image.jpg" # ini path untuk nyimpen hasil dekripsi
